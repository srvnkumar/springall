package org.example.jpqlnamedquery;
...
public class JpqlNamedQueryApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(JpqlNamedQueryApplication.class, args);
    }
